...
| KERNEL_REPO_URL        | [breakings/.../kernel](https://github.com/ophub/flippy-openwrt-actions/blob/main/openwrt_flippy.sh#L23) | 设置内核下载地址，默认从 [kernel](https://github.com/breakings/OpenWrt/tree/main/opt/kernel) 库里下载 Flippy 的内核，你可以设置为其他网络下载地址。`svn checkout` 地址格式如 `https://github.com/breakings/OpenWrt/trunk/opt/kernel` |
