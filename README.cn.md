...
| KERNEL_REPO_URL        | [ophub/flippy-kernel/library](https://github.com/ophub/flippy-openwrt-actions/blob/main/openwrt_flippy.sh#L23) | 设置内核下载地址，默认从 [flippy-kernel](https://github.com/ophub/flippy-kernel/tree/main/library) 库里下载 Flippy 的原版内核，你可以设置为其他网络下载地址。`svn checkout` 地址格式如 `https://github.com/ophub/flippy-kernel/trunk/library` |
